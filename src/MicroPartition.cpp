...
MicroPartition::MicroPartition(const ToucanGraph* graph)
    : G(graph) {}

MicroPartition::MicroPartition(const MicroPartition& other)
    : G(other.G), nodes(other.nodes),
      levels(other.levels), node_levels(other.node_levels),
